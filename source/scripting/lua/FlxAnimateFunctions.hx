...
class FlxAnimateFunctions {
	public static function implement() {
		...
		FunkinLua.registerFunction("addAnimationBySymbol", function(tag:String, name:String, symbol:String, ?framerate:Float = 24, ?loop:Bool = false, ?flipX:Bool = false, ?flipY:Bool = false) {
		...
		FunkinLua.registerFunction("addAnimationBySymbolIndices", function(tag:String, name:String, symbol:String, ?indices:Any = null, ?framerate:Float = 24, ?loop:Bool = false, ?flipX:Bool = false, ?flipY:Bool = false) {
			var obj:FlxAnimate = LuaUtils.getObjectDirectly(tag);
			if (obj == null) return false;
		...
		FunkinLua.registerFunction("addAnimationByFrameLabel", function(tag:String, name:String, frameLabel:String, ?framerate:Float = 24, ?loop:Bool = false, ?flipX:Bool = false, ?flipY:Bool = false) {
			var obj:FlxAnimate = LuaUtils.getObjectDirectly(tag);
			if (obj == null) return false;

			obj.anim.addByFrameLabel(name, frameLabel, framerate, loop, flipX, flipY);
			if (obj.anim.curAnim == null) {
				var obj2:ModchartAnimateSprite = cast (obj, ModchartAnimateSprite);
				if(obj2 != null) obj2.playAnim(name, true); //is ModchartAnimateSprite
				else obj.anim.play(name, true);
		...
		FunkinLua.registerFunction("addAnimationByFrameLabelIndices", function(tag:String, name:String, frameLabel:String, ?indices:Any = null, ?framerate:Float = 24, ?loop:Bool = false, ?flipX:Bool = false, ?flipY:Bool = false) {
			var obj:FlxAnimate = LuaUtils.getObjectDirectly(tag);
			if (obj == null) return false;
			...
			obj.anim.addByFrameLabelIndices(name, frameLabel, indices, framerate, loop, flipX, flipY);
			if (obj.anim.curAnim == null)
			{
				var obj2:ModchartAnimateSprite = cast (obj, ModchartAnimateSprite);
				if(obj2 != null) obj2.playAnim(name, true); //is ModchartAnimateSprite
