...
class LuaUtils
{
	...
	#if HSCRIPT_ALLOWED public static var lastCalledHScript:scripting.hscript.FunkinHscript = null; #end
	...
	public static function loadFrames(spr:FlxSprite, image:String, spriteType:String)
	{
		switch(spriteType.toLowerCase().replace(' ', ''))
		{
			...
			case 'animate', 'animateatlas', 'spritemap':
	...
	public static function loadMultipleFrames(spr:FlxSprite, images:Array<String>)
	{
		spr.frames = Paths.getMultiAnimateAtlas(images);
	}
	...
	public static function getTweenEaseByString(?ease:String = '', ?value:Float = 1) {
		switch(ease.toLowerCase().trim()) {
			...
			case 'stepped': return (t:Float) -> Math.floor(t * value) / value;
		}
