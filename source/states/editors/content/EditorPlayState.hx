...
class EditorPlayState extends ScriptedSubState
{
	...
	private function cachePopUpScore() {
		for (rating in ratingsData) Paths.image(PlayState.formatUI(rating.image));
		for (i in 0...10) Paths.image(PlayState.formatUI('num$i'));
	}
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		rating.pixelPerfectRender = PlayState.isPixelStage;
		rating.pixelPerfectPosition = PlayState.isPixelStage;
		...
		for (i in seperatedScore)
		{
			...
			numScore.loadGraphic(Paths.image(PlayState.formatUI('num$i')));
			...
			numScore.pixelPerfectRender = PlayState.isPixelStage;
			numScore.pixelPerfectPosition = PlayState.isPixelStage;
