...
@:structInit class SaveVariables
{
	...
	public var cacheOnGPU:Bool = #if (mac || web) false #else true #end; // GPU Caching made by Raltyro
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		if (FlxG.save.data.framerate == null) {
			data.framerate = Std.int(FlxMath.bound(refreshRate, 30, 240));
		}
		#end

		var framerate = data.vSync ? refreshRate : data.framerate;
